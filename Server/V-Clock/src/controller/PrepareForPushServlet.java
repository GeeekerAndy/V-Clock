...
public class PrepareForPushServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// String sql3 =
		// "select arrivingdate from visitingrecord where gname=? and eid =?";
...
//								+ "&arrivingDate="
//								+ arrivingDate);
						request.getRequestDispatcher("/servlet/PushMessageServlet?eid="
								+ eid
								+ "&gname="
								+ gname
								+ "&arrivingDate="
								+ arrivingDate).forward(request,response);
					}
				}
			}
		} catch (Exception e) {
